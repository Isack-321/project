  ...
  const loadBlockchainData = async () => {
    ...
    if (networkId===5777) {
      ...
      const electionContract = new web3.eth.Contract(
        Election.abi,"0x50409d70cDd7d39ccd4bc9f8b3F2D5A7FcFCc20F")
  ...
  if (loading === true) {
    content = (
      <p className="text-center">
        Loading...{loading2 ? <span>loading2....</span> : ""}
      </p>
    );
  } else {
    content = (
      ...
      <div className="app">
        ...
        <div className="lead_title">
          ...
          <Button variant="contained" onClick={showLeader} variant="contained">
            LEADING
          </Button>
        </div>
        {showlead && (
